<template>
  <q-page class="container">
    <div class="mx-auto lg:px-20 px-4 py-4">
      <h2 class="text-h2"><strong>Terms and Conditions</strong></h2>

      <p class="text-h4">Welcome to mizomade.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of MizoMade's Website, located at https://www.mizomade.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use mizomade.com if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing mizomade.com, you agreed to
        use cookies in agreement with the MizoMade's Privacy Policy.
      </p>
      ...
      <p class="text-h4">License</p>

      <p>
        Unless otherwise stated, MizoMade and/or its licensors own the
        intellectual property rights for all material on mizomade.com. All
        intellectual property rights are reserved. You may access this from
        mizomade.com for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from mizomade.com</li>
        <li>Sell, rent or sub-license material from mizomade.com</li>
        <li>Reproduce, duplicate or copy material from mizomade.com</li>
        <li>Redistribute content from mizomade.com</li>
      </ul>
      ...
      <p>
        ...
        <a href="https://www.termsfeed.com/terms-conditions-generator/"
          >TermsFeed Free Terms and Conditions Generator</a
        >.
      </p>
      ...
      <p>
        ...
        MizoMade does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of MizoMade,its agents and/or affiliates. Comments reflect the
        views and opinions of the person who post their views and opinions. To
        the extent permitted by applicable laws, MizoMade shall not be liable
      ...
      <p>
        MizoMade reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant MizoMade a non-exclusive license to use, reproduce,
        edit and authorize others to use, reproduce and edit any of your
        Comments in any and all forms, formats or media.
      </p>

      <p class="text-h4">Hyperlinking to our Content</p>
      ...
      <p>
        ...
        the hyperlink compensates the absence of MizoMade; and (d) the link is
      ...
      <p>
        ...
        e-mail to MizoMade. Please include your name, your organization name,
      ...
      <p>
        No use of MizoMade's logo or other artwork will be allowed for linking
        absent a trademark license agreement.
      </p>

      <p class="text-h4">iFrames</p>
      ...
      <p class="text-h4">Content Liability</p>
      ...
      <p class="text-h4">Your Privacy</p>

      <p>Please read Privacy Policy</p>

      <p class="text-h4">Reservation of Rights</p>
      ...
      <p class="text-h4">Removal of links from our website</p>
