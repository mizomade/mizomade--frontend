<template>
  <q-page class="container">
    <div class="mx-auto q-my-md q-py-md">
      <p class="text-h2 text-weight-semibold">Privacy Policy</p>
      ...
      <br />
      <p class="text-h3 text-weight-semibold">Interpretation and Definitions</p>
      <p class="text-h4 text-weight-semibold">Interpretation</p>
      <p>
      ...
      <p class="text-h4 text-weight-semibold">efinitions</p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to MizoMade, Aizawl.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p><strong>Country</strong> refers to: Mizoram, India</p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to MizoMade.com, accessible from
            <a
              href="https://www.mizomade.com"
              rel="external nofollow noopener"
              target="_blank"
              >https://www.mizomade.com</a
            >
          </p>
        </li>
        <li>
      ...
      <p class="text-h3 text-weight-semibold">
        Collecting and Using Your Personal Data
      </p>
      <p class="text-h3 text-weight-semibold">ypes of Data Collected</p>
      <p class="text-h4 text-weight-semibold">Personal Data</p>
      <p>
      ...
      <p class="text-h4 text-weight-semibold">Usage Data</p>
      ...
      <ul>
        ...
        <li>
          ...
          disabling, or deleting local shared objects?&quot; available at <br />
          <a
      ...
      <p class="text-h4 text-weight-semibold">Business Transactions</p>
      <p>
      ...
      <p class="text-h4 text-weight-semibold">Law enforcement</p>
      <p>
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <p class="text-h4 text-weight-semibold">Other legal requirements</p>
      <p>
      ...
      <p class="text-h3 text-weight-semibold">Security of Your Personal Data</p>
      <p>
      ...
      <p class="text-h3 text-weight-semibold">Children's Privacy</p>
      <p>
      ...
      <p class="text-h3 text-weight-semibold">Links to Other Websites</p>
      <p>
      ...
      <p class="text-h3 text-weight-semibold">Changes to this Privacy Policy</p>
      <p>
      ...
      <p class="text-h3 text-weight-semibold">Contact Us</p>
      <p>
        If you have any questions about this Privacy Policy, You can contact us:
      </p>
      <ul>
        <li>
          <p>By email: mizomade.official@gmail.com</p>
        </li>
        <li>
          <p>
            By visiting this page on our website:
            <a
              href="https://mizomade.com/info/contactus"
              rel="external nofollow noopener"
              target="_blank"
              >https://mizomade.com/info/contactus</a
            >
          </p>
        </li>
        <li>
          <p>By phone number: +91 6009229392</p>
        </li>
      </ul>
      <br />
    </div>
